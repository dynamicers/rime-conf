...
local function vim_mode(key, env)
	...
	if key.keycode == 65307 and in_normal_mode == false then
		in_normal_mode = true
  ...
  -- 3. Normal Mode -> Insert Mode
  if in_normal_mode and enter_insert_keys[key.keycode] then
